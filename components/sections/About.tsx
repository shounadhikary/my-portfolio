...
export function About() {
  ...
  return (
    <section id="about" className="py-24 bg-[#050810]">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative mb-10">
              <div className="w-64 h-64 rounded-3xl relative overflow-hidden"
                style={{ background: "linear-gradient(135deg, #0F1923, #1A2332)" }}>
              ...
              {/* Status badge */}
              <div className="absolute -bottom-4 -right-4 glass border border-[#1E2D3D] rounded-2xl px-4 py-2 flex items-center gap-2">
            ...
            <div className="grid grid-cols-2 gap-4 w-full max-w-xs">
              {facts.map(({ icon: Icon, label, value, color }) => (
                <div key={label} className="glass border border-[#1E2D3D] rounded-2xl p-4 text-center hover:border-cyan-400/30 transition-colors">
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <span className="flex items-center gap-2 text-sm text-slate-400 glass border border-[#1E2D3D] px-4 py-2 rounded-full">
            ...
            {/* Education card */}
            {education.map((edu) => (
              <div key={edu.institution} className="mt-8 glass border border-[#1E2D3D] rounded-2xl p-6 hover:border-cyan-400/30 transition-colors">
                <div className="flex items-start gap-4">
                  <span className="text-3xl">{edu.logo}</span>
                  <div>
                    <h3 className="font-display text-slate-100 font-semibold text-lg">{edu.degree}</h3>
